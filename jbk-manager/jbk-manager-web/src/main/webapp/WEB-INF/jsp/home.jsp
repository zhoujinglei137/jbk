...
<div class="zxcf_nav_wper">
    <div class="zxcf_nav clearfix px1000">
        <div class="zxcf_nav_l fl"><img src="images/jbk2.png" alt="">&nbsp;&nbsp;&nbsp;&nbsp;<img
                src="images/zxcf_logo.png"></div>
...
<div class="zscf_con_wper pb30">
    <div class="zscf_con px1000">
        <div class="zscf_block1 mt30 ">
            <h2 class="zscf_block1_tit clearfix"><span class="fl"><strong>发标预告</strong>十一来啦~\(≧▽≦)/~啦啦啦，小宝送福利，现在投资，坐等拿钱</span><a
                    href="" class="fr">查看更多>></a></h2>
        ...
        <div class="zscf_block2 mt30 clearfix ">
            <div class="zscf_block2_l fl">
                        <c:forEach items="${products1}" var="noob" varStatus="i">
                            <div class="block2_biao clearfix">
                                <div class="clearfix">
                                    ...
                                    <div class="block2_biao_r fr">
                                        <div class="tjxm_jindu ">
                                            ...
                                            <span class="fl">${noob.yearYield}%</span>
                                        </div>
                                    </div>
                                </div>
                                <ul class="clearfix clear block2_biao_ul">
                                    ...
                                    <li>
                                        项目总额：<span>${noob.itemlimit}元</span>
                                    </li>
                                    <li>
                                        <a href="product/get?pid=${noob.id}" class="invest_btn">立即投资</a>
                                    </li>
                                </ul>
                            </div>
                        </c:forEach>
            ...
            <div class="zscf_block3 mt30 ">
                <h2 class="block3_tit clearfix"><span class="block3_curspan">项目列表</span><em><img
                        src="images/shu.png"
                        alt=""></em><span>债权转让</span><a
                        href="">更多></a></h2>
                            ...
                            <div class="block3_proone clearfix clear">
                                ...
                                <div class="fl proone_center">
                                    ...
                                    <ul class="clearfix proone_center_ul clear pt10">
                                        <li>预计年化收益:<span>${noob.yearYield}%</span></li>
                                        <li>投资期限:<span>${noob.investDeadline}天</span></li>
                                        <li>项目总额：<span>${noob.itemlimit}元</span></li>
                                    </ul>
                                </div>
                                <!--  -->

                                <a href="product/get?pid=${noob.id}" class="block3_btn fl">立即投资</a>
                            </div>
                    </form>
                            <!--listone  -->
                </c:forEach>
                ...
                <div class="zscf_block5 mt30 clearfix">
                    <div class="zscf_block5_l fl mr20">
                        <h2 class="block3_tit clearfix block5_l_tit"><span
                                class="block3_curspan news_span">行业动态</span><em><img
                                src="images/shu.png" alt=""></em><span class="news_span">媒体报道</span><a href="">更多></a>
                        </h2>
                    ...
                    <div class="zscf_block5_r fl">
                        <h2 class="block5_r_tit clearfix"><span class="fl ">投资排行榜</span><em
                                class="fr block5_r_tit_em"><a
                                href="javascript:;" class="brt_acur">月排行</a><a href="javascript:;">周排行</a><a
                                href="javascript:;">总排行</a></em></h2>
        ...
        <div class="zscf_bottom_wper">
            <div class="zscf_bottom px1000 clearfix">
                <p class="fl">© 2014 zhongxincaifu &nbsp; &nbsp;&nbsp; 聚宝坑金融信息服务股份有限公司 &nbsp;&nbsp;&nbsp;
                    鄂ICP备14017254号-1</p>
