...
<div align="center"  title="新增管理" data-options="fit:true">
  <form class="main_form"  id="adminAddForm" name="adminAddForm" method="post">
    <p class="easyui-panel" title="新增管理">
      ...
      <%--</p>--%>
    <p class="input_container">
      <input class="easyui-textbox" name="id" label="管理员编号：" labelPosition="top" value="${userAdmin.getId}" >
    </p>
    <p class="input_container">
      <input class="easyui-textbox" name="loginName" label="登录名：" labelPosition="top" value="${userAdmin.getLoginName}" >
    </p>
    <p class="input_container">
      <input  class="easyui-textbox" name="userName" label="用户名：" labelPosition="top" multiline="true" value="${userAdmin.getUserName}">
    </p>
    <p class="input_container">
      <input class="easyui-textbox" name="passWord" label="登陆密码：" labelPosition="top" value="${userAdmin.getPassWord}">
    </p>
    <p>
